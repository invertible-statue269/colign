...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/gobenpark/colign/gen/proto/task/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// RPC.
	TaskServiceReorderTasksProcedure = "/task.v1.TaskService/ReorderTasks"
)
...
// ReorderTasks calls task.v1.TaskService.ReorderTasks.
...
func (UnimplementedTaskServiceHandler) ReorderTasks(context.Context, *connect.Request[v1.ReorderTasksRequest]) (*connect.Response[v1.ReorderTasksResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("task.v1.TaskService.ReorderTasks is not implemented"))
}
